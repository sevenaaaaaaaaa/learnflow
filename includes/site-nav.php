...
<header class="lf-nav" data-od-id="site-nav">
  <div class="lf-nav-inner">
    ...
    <div class="lf-nav-actions">
      <?= lf_theme_toggle() ?>
      <?php if ($student): ?>
        <a class="btn ghost lf-nav-cta" href="/dashboard"><?= lf_e((string)($student['name'] ?? '我')) ?></a>
      <?php else: ?>
        <a class="lf-nav-link lf-nav-login" href="/login">登录</a>
        <a class="btn primary lf-nav-cta" href="/courses">开始学习</a>
      <?php endif; ?>
    </div>
  </div>
</header>
